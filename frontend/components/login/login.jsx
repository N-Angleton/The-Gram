      ...
      <div className="signInGrid">
        <div className="signInColumn">
          <div className="signInContainer">
              ...
              <div
                className={
                  this.state.username.length
                    ? "signInUsernameInputContainer transition"
                    : "signInUsernameInputContainer"
                }
              >
                <input
                  type="text"
              ...
              <div
                className={
                  this.state.password.length
                    ? "signInPasswordInputContainer transition"
                    : "signInPasswordInputContainer"
                }
              >
                <input
            ...
            <button className="demoUserButton" onClick={() => this.loginDemo()}>
              Demo User
            </button>
          </div>
