...
export class Post extends React.Component{
    ...
    updatePost(e){
        e.preventDefault()
        this.props.updatePost({id: this.props.post.id, description: this.state.description})
            ...
            <li className="postItem">
                ...
                {(this.state.editing) ?
                    <form className="editPostForm">
                        <input type="text" value={this.state.description} onChange={(e) => this.updateDescription(e)} />
